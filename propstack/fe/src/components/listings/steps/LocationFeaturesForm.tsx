...
export function LocationFeaturesForm({ onBack, onNext, data, onUpdate }: LocationFeaturesFormProps) {
  ...
  useEffect(() => {
    if (isLoaded) {
      ...
      if (data.address && geocoder.current) {
        console.log('Starting geocoding for:', data.address)
        ...
        if (place.geometry?.location) {
          ...
          const feature: NearbyFeature = {
            ...
            distance: calculateDistance(
              data.fullAddress?.geometry?.location,
