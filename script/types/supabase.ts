  ...
  public: {
    Tables: {
      ...
      staging_failed_documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "staging_failed_documents_document_id_fkey"
            columns: ["document_id"]
            isOneToOne: false
            referencedRelation: "staging_documents"
            referencedColumns: ["id"]
          },
        ]
      }
      staging_jobs: {
        ...
        Relationships: [
          {
            foreignKeyName: "staging_jobs_document_id_fkey"
            columns: ["document_id"]
            isOneToOne: false
            referencedRelation: "staging_documents"
            referencedColumns: ["id"]
      ...
      staging_validation_failures: {
        Row: {
          error_message: string | null
          field_name: string | null
          id: number
          raw_data: Json | null
          staging_job_id: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "staging_validation_failures_staging_job_id_fkey"
