...
CREATE OR REPLACE VIEW "public"."job_role_embeddings_view" AS
 SELECT "j"."id" AS "job_id",
    "j"."title" AS "job_title",
    "j"."company_id" AS "job_company_id",
    "j"."role_id" AS "job_role_id",
    "j"."embedding" AS "job_embedding",
    "r"."id" AS "role_id",
    "r"."title" AS "role_title",
    "r"."company_id" AS "role_company_id",
    "r"."division_id" AS "role_division_id",
    "r"."general_role_id" AS "general_role_ref_id",
    "r"."embedding" AS "role_embedding",
    "gr"."id" AS "general_role_id",
    "gr"."title" AS "general_role_title",
    "gr"."embedding" AS "general_role_embedding"
   FROM (("public"."jobs" "j"
     LEFT JOIN "public"."roles" "r" ON (("j"."role_id" = "r"."id")))
     LEFT JOIN "public"."general_roles" "gr" ON (("r"."general_role_id" = "gr"."id")));


ALTER TABLE "public"."job_role_embeddings_view" OWNER TO "postgres";
...
GRANT ALL ON TABLE "public"."job_role_embeddings_view" TO "anon";
GRANT ALL ON TABLE "public"."job_role_embeddings_view" TO "authenticated";
GRANT ALL ON TABLE "public"."job_role_embeddings_view" TO "service_role";
